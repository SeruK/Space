...
public static class DebugUtil
{
	...
	[Conditional("DEBUG")]
	public static void DrawLine(UnityEngine.Vector3 in_start, UnityEngine.Vector3 in_end, UnityEngine.Color in_color)
	{
		UnityEngine.Debug.DrawLine(in_start, in_end, in_color);
	}
}